EEMs_assessment <- function(buildingSubject, buildingsRdf, timeseriesObject, settings, libraryPath=""){
  
  library(biggr)
  
  source(paste0(if(libraryPath!=""){paste0(library,"/")}else{""},"HourlyMeasurementAndVerificationModel.R"))
